...
void find_sum(const int array_a[][5], const int array_b[][5], int array_c[][5]); //求两个矩阵的和，并保存在第三个矩阵中
void find_sub(const int array_a[][5], const int array_b[][5], int array_c[][5]); //求两个矩阵的差，并保存在第三个矩阵中
...
//将矩阵内的元素输出
void output(const int array_b[][5])
{
    int i, j;
    for (i = 0; i < 4; i++)
    {
...
//求两个矩阵的和，并保存在第三个矩阵中
void find_sum(const int array_a[][5], const int array_b[][5], int array_c[][5])
{
    int i, j;
    for (i = 0; i < 4; i++)
    {
...
//求两个矩阵的差，并保存在第三个矩阵中
void find_sub(const int array_a[][5], const int array_b[][5], int array_c[][5])
{
    int i, j;
    for (i = 0; i < 4; i++)
    {
